	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex items-center w-full h-full')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('search-input-wrapper w-full h-full flex items-center gap-4')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('What are you looking for?'),
										$elm$html$Html$Attributes$class('search-input text-lg lg:text-3xl text-[#333] w-full h-full outline-none'),
										$elm$html$Html$Attributes$value(model.content),
										$elm$html$Html$Events$onInput($author$project$Search$Change)
									]),
								_List_Nil)
							]))
					])),
